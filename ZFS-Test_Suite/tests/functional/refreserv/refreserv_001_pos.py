...
log_assert("Reservations are enforced using the maximum of 'reserv' and 'refreserv'")
...
log_mustnot([[DD, "if=/dev/zero", "of=$mntpnt/" + TESTFILE, "bs=1M", "count=15"]])
...
log_pass("Reservations are enforced using the maximum of  'reserv' and 'refreserv'")
