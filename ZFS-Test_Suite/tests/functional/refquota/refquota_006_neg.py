...
badopt = ["None","-1","1TT","%5","123!","@456","7#89","0\$","abc123%","123%s","12%s3","%c123","123%d","%x123","12%p3","^def456","\\0","x0"]

for i in badopt:
    log_mustnot([[ZFS,"set", "refquota="+i, TESTPOOL+"/"+TESTFS]])
    log_mustnot([[ZFS, "set", "refreserv="+i, TESTPOOL+"/"+TESTFS]])
