...
log_must ([["./file_write", "-o", OP, "-f", TESTDIR1+"/"+TESTFILE0, "-c", NUM_WRITES, "-d", DATA]])
...
log_note ("Verify that a nested file system with a mounted file system cannot be destroyed")
